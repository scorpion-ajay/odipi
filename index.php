...
<div id="intro" class="section scrollspy">
    <div class="container">
        <div class="row">
            <div  class="col s12">
                <h2 class="center header text_h2"> Democracy is built through open societies that share information. When there is <span class="span_h2"> Information  </span>there is <span class="span_h2"> Enlightenment  </span>. When there is <span class="span_h2"> Debate  </span>,there are solutions. For good ideas and true <span class="span_h2"> Innovation  </span>you need interaction, conflict, argument, debate.
                <p><a href="about.php"><span class="span_h2"> Read More  </span></a></p> </h2>
            </div>
