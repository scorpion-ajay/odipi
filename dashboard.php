...
<div class="section" id="index-banner1">
        ...
        <div class="col l3 s12 m6" style="float: left;">
          <div class="card white ">
            <div class="card-content" style="color: #2196F3; padding-bottom: 456px;">
                <div style="border: 1px solid #2196F3;">
              <p>
              <img src="img/avatar1.png" style="height: 90px; width: 90; float: left;">
              <ul style="list-style: none;"> <li style="font-size:120%; font-weight: 600; padding: 5px; float: right;">Sample User</li>
              <br>
              <br>
              <li style="float: right; padding: 5px; text-decoration: underline;"><a href="#">Edit profile</a></li>
              <br>
              </p>
           </ul>
           </div>
        ...
        <div class="col l4 ">
            ...
            <div class="card-image">
              <img src="img/project6.jpeg">
              <span class="card-title" style="font-weight: 500; font-size: 30px;">Should women tolerate the man dominated society?</span>
            </div>
            <div class="card-content">
              <p> Women in our country have always been treated below man. What are your views about it? Don't you feel raged?</p>
            </div>
            <div class="card-action">
              <a href="#">Debate for</a>
              <a href="#">Debate against</a>
            </div>
          </div>
      </div>
      ...
      <div class="col l4 ">
            ...
            <div class="card-image">
              ...
              <span class="card-title" style="font-weight: 500; font-size: 30px;">How can entrepreneurship be encouraged in India?</span>
            </div>
            <div class="card-content">
              <p>You might have heard about this term quite a few times in the recent past. Know more about it.</p>
            </div>
            <div class="card-action">
              <a href="#">Debate for</a>
              <a href="#">Debate against</a>
