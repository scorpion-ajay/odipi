...
<!--Navigation-->
 ...
 <script type="text/javascript">
            ...
            var hash = <?php include("connect.php");
                            $un = $_POST['username1'];
                            $sql = "SELECT firstname FROM userinfo where phone = '$un'";
            ...
            document.write('<br><img src="data:image/png;base64,' + data + '"><br><br>');
            </script>
...
<div class="section" id="index-banner1">
    <div class="container">
        ...
        <form class="col l6 s12 m6" action="dashboard.php" method="post">
